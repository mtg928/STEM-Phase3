...
public class ControlPanel extends JToolBar {
    ...
    public ControlPanel(int radius, List<Node> nodes, List<Edge> edges,Point mousePt) {
    ...
    private class ColorAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            color = JColorChooser.showDialog(
                    GraphDrawPanel.graph, "Choose a color", color);
            if (color != null) {
    ...
    private class NewNodeAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            Node.selectNone(nodes);
             ...
             Point p = GraphDrawPanel.graph.getMousePoint().getLocation(); 
    ...
    private class SelectedNodeAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
             ...
             JOptionPane.showConfirmDialog(GraphDrawPanel.graph, Node.getSelectedOne(nodes, GraphDrawPanel.graph.getMousePoint()).getColor(), "Selected", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private class RandomAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            for (int i = 0; i < 16; i++) {
                Point p = new Point(rnd.nextInt(GraphDrawPanel.graph.getWidth()), rnd.nextInt(GraphDrawPanel.graph.getHeight()));
