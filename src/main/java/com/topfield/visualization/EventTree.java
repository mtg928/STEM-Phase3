 ...
 *
 */
public class EventTree     extends     JApplet
{
    private static final long serialVersionUID = 2202072534703043194L;

    private static final Dimension DEFAULT_SIZE = new Dimension(530, 320);

   // private JGraphXAdapter<URL, DefaultEdge> jgxAdapter;
   ...
   /* public static void main(String[] args)
    ...
    public void init()
    {
      ...
      /*  Graph<URL, DefaultEdge> g = new DefaultDirectedGraph<>(DefaultEdge.class);
        ...
        DefaultEdge edge =g.addEdge(jgrapht, wikipedia);
        DefaultEdge edge2 =g.addEdge(google, jgrapht);
        ...
        g.addEdge(wikipedia, google);
            ...
            Logger.getLogger(EventTree.class.getName()).log(Level.SEVERE, null, ex);
        }
