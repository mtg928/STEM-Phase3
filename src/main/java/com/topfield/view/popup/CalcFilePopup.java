 ...
 * @author Murali
 */
public class CalcFilePopup extends javax.swing.JPanel {
    
    private DatareferDao datareferDao = new DatareferDaoImpl();

    /**
     * Creates new form CalcFilePopup
     */
    public CalcFilePopup(String calName) {
        initComponents();
        
        for (Datarefer datarefer : datareferDao.getAllDatareferByCalType(calName)) {
    ...
    public void setComponentId(String comId){
    
        jTextField1.setText(comId);
    }
    ...
    public void setFailureRate(Double failureRate){
        ...
        jTextField4.setText(failureRate.toString());
    }
    ...
    public void setProbability(Double probability){
        ...
        jTextField9.setText(probability.toString());
    }
    
    public double getFailureModePer(){
    
        return NumberConversion.NVLDouble(jTextField5.getText(), 0);
    }
    
    public void setFailureModePer(Double failureper){
    
        jTextField5.setText(failureper.toString());
    }
    
    public double getUNRFailurePer(){
    
        return NumberConversion.NVLDouble(jTextField7.getText(), 0);
    }
    
    public void setUNRFailurePer(Double nurfailure){
    
        jTextField7.setText(nurfailure.toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Failure Mode");

        jLabel4.setText("Failure Rate (/h)");

        jLabel5.setText("Failure Mode %");

        jLabel7.setText("Unrevealed %");
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new CalcHdrPopup("add", "FMEA", new String[]{"Qualitative"}));
