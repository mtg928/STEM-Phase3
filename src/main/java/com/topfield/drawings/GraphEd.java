...
public class GraphEd extends JApplet implements GraphSelectionListener,KeyListener {
   ...
   protected Action undo, redo, remove, group, ungroup, tofront, toback, cut, copy, paste; // Actions which Change State
