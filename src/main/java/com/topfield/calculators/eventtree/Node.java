...
public class Node<T> {
     ...
     */
    /*public Node(T contents, Point p, int r, Color color) {
        this.p = p;
        this.r = r;
        this.color = color;
        this.contents = contents;
    ...
    private void setBoundary(Rectangle b) {
        //b.setBounds((getP().x + getWidthPerLevel()) - r, getP().y - r, 2 * r, 2 * r);
    ...
    public void setChildrens(Node<T> child0, Node<T> child1) {
        this.contents = null;
    ...
    public void draw2(Graphics g) {
        ...
        int dx = getWidthPerLevel();
        int vx = Math.min(p0.x - dx, p1.x - dx);
        //g.drawLine(p.x, p.y, p.x+100, p.y);

        //g.fillRect((p0.x + getWidthPerLevel()) - 2, p0.y - 2, 4, 4);
        //g.fillRect(p1.x-2, p1.y-2, 4, 4);
        
        //g.drawLine(p0.x, p0.y, p0.x + getWidthPerLevel(), p0.y);
    ...
    /**
     * @return the widthPerLevel
     */
    public int getWidthPerLevel() {
        return widthPerLevel;
    }

    /**
     * @param widthPerLevel the widthPerLevel to set
     */
    public void setWidthPerLevel(int widthPerLevel) {
        this.widthPerLevel = widthPerLevel;
    }
